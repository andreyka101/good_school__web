  ...
  build: {
    rollupOptions: {
      input: {
        ...
        usloviyaobucheniya: resolve('usloviya-obucheniya.html'),
        serviceagreement: resolve('service-agreement.html'),
        politikakonfidencialnosti: resolve('politika-konfidencialnosti.html'),
        oferta: resolve('oferta.html'),
        obrabotkadannyh: resolve('obrabotka-dannyh.html'),
        onas: resolve('o-nas.html'),
        faq: resolve('faq.html'),
        s404: resolve('404.html'),
